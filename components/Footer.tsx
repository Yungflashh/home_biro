...
export default function Footer() {
  const footerLinks = {
    ...
    Services: [
      ...
      { name: 'Neighbourhood Tours', href: '#solution' },
      { name: 'Legal Guide', href: '#' },
      { name: 'Roommate Match', href: '#' }
    ],
    Support: [
      { name: 'Help Center', href: '#' },
      { name: 'Contact Us', href: 'mailto:support@homebiro.com' },
      { name: 'FAQ', href: '#' },
      ...
      <div className="container-custom py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            ...
            >
              ...
              <span className="font-bricolage font-bold text-3xl">Homebiro</span>
            </motion.div>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              <strong className="text-white">All-in-one tenant concierge service.</strong><br />
              Our mission is to revolutionize the rental experience by eliminating agent 
              extortion and providing transparent, reliable home-finding services.
            </motion.p>
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              whileInView={{ opacity: 1, y: 0 }}
            ...
            >
              ...
              >
                ...
                <span>support@homebiro.com</span>
              </a>
            </motion.div>
          </div>
        ...
        >
          <div className="text-center mb-6">
            <h3 className="font-bricolage font-bold text-2xl mb-2">Download Our App</h3>
            <p className="text-gray-400">Get started on your home-finding journey today</p>
          </div>
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <motion.button
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-6 py-3 bg-white text-gray-900 rounded-xl font-semibold flex items-center justify-center space-x-3 hover:bg-gray-100 transition-all"
            >
            ...
            >
              {socialLinks.map((social) => (
                <motion.a
                  ...
                  className="w-10 h-10 rounded-full bg-gray-700 hover:bg-primary-600 flex items-center justify-center transition-all"
