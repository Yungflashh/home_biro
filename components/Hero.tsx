  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="absolute inset-0 -z-10">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-primary-300 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float delay-200"></div>
        <div className="absolute -bottom-8 left-1/2 w-72 h-72 bg-primary-100 rounded-full mix-blend-multiply filter blur-3xl opacity-30 animate-float delay-300"></div>
      </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            >
              ...
              inspections, and neighbourhood tours, so you can move into a home 
            ...
            <div className="relative aspect-square rounded-3xl overflow-hidden shadow-2xl">
              ...
              <div className="w-full h-full bg-gradient-to-br from-primary-400 to-primary-600 flex items-center justify-center">
                <div className="text-center text-white p-8">
                  ...
                  <p className="text-lg font-semibold">HomeBiro Image</p>
                  <p className="text-sm opacity-80 mt-2">Model pointing to roll-up stand</p>
                </div>
              </div>
            </div>
